<?php 
class wb_blog_title extends WP_Widget {
    /** constructor */
    function wb_blog_title() {
		$widget_ops = array('classname' => 'wb_blog_title', 'description' => __( 'Automatic title widget' ) );
		$this->WP_Widget('wb-blog-title', __('Blog Title'), $widget_ops);
		$this->alt_option_name = 'wb_blog_title';	
    }
...
// register widget
add_action('widgets_init', create_function('', 'return register_widget("wb_blog_title");'));