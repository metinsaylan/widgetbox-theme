 ...
 * Search Widget Class
 */
class wb_posts_widget extends WP_Widget {
    /** constructor */
    function wb_posts_widget() {
		$widget_ops = array('classname' => 'blog-posts', 'description' => __( 'Posts on your blog' ) );
		$this->WP_Widget('wb-blog-posts', __('Blog Posts'), $widget_ops);
		$this->alt_option_name = 'wb_blog_posts';	
    }
...
// register widget
add_action('widgets_init', create_function('', 'return register_widget("wb_posts_widget");'));